...
namespace Pharma.Domain
{
    ...
    /// <summary>
    /// There are no comments for Pharma.Domain.grupos_roles, Pharma.Domain in the schema.
    /// </summary>
    public partial class grupos_roles {
        ...
        /// </summary>
        public virtual ISet<privilegios> privilegios
        {
            get;
            set;
        }
        ...
        /// </summary>
        public virtual ISet<usuarios> usuarios
        {
            get;
            set;
        }
