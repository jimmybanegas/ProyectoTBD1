...
CREATE TABLE `contactos_clientes` (
  ...
  `usuario_crea` varchar(45) DEFAULT NULL,
  `usuario_actu` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id_contactocliente`,`nombre`,`correo`,`telefono`,`id_cliente`),
...
CREATE TABLE `direcciones_clientes` (
  ...
  `usuario_crea` varchar(45) DEFAULT NULL,
  `usuario_actu` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id_direccioncliente`,`direccion`,`id_cliente`),
...
CREATE TABLE `productos` (
  ...
  KEY `fk_PRODUCTO_CATEGORIA_PRODUCTO1_idx` (`cod_categoria`),
  CONSTRAINT `fk_PRODUCTO_CATEGORIA_PRODUCTO1` FOREIGN KEY (`cod_categoria`) REFERENCES `categoria_productos` (`cod_categoria`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `calcular_precio_consumidor`(p_costo DOUBLE) RETURNS int(11)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` FUNCTION `calcular_precio_mayorista`(p_costo DOUBLE, p_porcentaje integer) RETURNS int(11)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_ins_ordenes_de_compra` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
